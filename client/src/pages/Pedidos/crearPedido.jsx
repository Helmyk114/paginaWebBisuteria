        ...
        <Acordeon titulo={"Datos del cliente"}>
          ...
          >
            <div className="flex flex-col">
              <InputText
                ref={(el) => {
                  refs.current.idCardClient = el;
                }}
                {...register("idCardClient", {
              ...
              />
              {errors.idCardClient && (
                <span>{errors.idCardClient.message}</span>
              )}
            </div>
            <div className="flex flex-col">
              <InputText
          ...
          >
            <div className="flex flex-col">
              ...
              {errors.clientAddress && (
                <span>{errors.clientAddress.message}</span>
              )}
            </div>
            <div className="flex flex-col">
              <InputText
                ref={(el) => {
                  refs.current.clientPhone = el;
                }}
              ...
              >
                <div className="cardPerfil">
                  <div className="contenedor1">
                    ...
                    />
                    <Spacer x={3} />
                    <Texto1Card texto={product.producto} />
                    <div style={{ display: "flex", justifyContent: "center" }}>
                      <BotonCantidad />
                    </div>
                  </div>
                  <div className="contenedor2">
                    <Texto2Card texto2={product.precio} />
